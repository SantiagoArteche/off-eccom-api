export class UpdateUserDTO {
  ...
  static create(obj: { [key: string]: any }): [string?, UpdateUserDTO?] {
    ...
    if ((email && email.length < 8) || email.length > 30)
      return ["Email must have more than 7 and less than characters 30"];
    ...
    return [
      undefined,
      new UpdateUserDTO(email, firstName, lastName, password, age),
    ];
  }
}
